...
<section class="section-services">
		<div class="container">
            ...
            <a href="build.php" class="btn btn-primary btn-lg">Explore Our Builds</a>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="build.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="shop.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="fix.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="virus.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="connectivity.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						...
						<div class="part-2">
							...
							<a href="laptop.php"><i class="fas fa-arrow-circle-right"></i>Read More</a>
						</div>
					</div>
				</div>
				<!-- / End Single Service -->
