                ...
                <div class="manage-account__form">
                    <form class="form" method="post" action="update_account.php">
                        <div class="form__group">
                            <input type="text" class="form__input" name="new_username" placeholder="Enter new username" value="<?php echo $row['username']; ?>" required >
                            <label class="form__label">Enter new username</label>
                        </div>
                        <div class="form__group">
                            <input type="email" class="form__input" name="new_email" placeholder="Enter new email" value="<?php echo $row['email']; ?>" required>
                            <label class="form__label">Enter new email</label>
                        </div>
                        <div class="form__group">
                            <input type="tel" class="form__input" name="new_phone" placeholder="Enter new phone" value="<?php echo $row['phone']; ?>" required>
