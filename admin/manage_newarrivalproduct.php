...
<head>
    <title>Admin - Manage New Arrival Products</title>
...
<body>
    ...
    <div id="main">
        ...
        <h2 class="product-heading">New Arrival Product List</h2>
        ...
        <div class="new-button-container">
            <div class="box-header with-border">
                <a href="#addProductModal" data-toggle="modal" class="btn btn-primary btn-sm btn-flat new-button">
                    <i class="fa fa-plus"></i> Add New Arrival Product
                </a>
            </div>
        </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    include_once 'new_arrival_modal.php';
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM new_arrivals WHERE product_name LIKE '%$searchQuery%' LIMIT $offset, $productsPerPage";
                    } else {
                        // Default SQL query without search functionality
                        $sql = "SELECT * FROM new_arrivals LIMIT $offset, $productsPerPage";
                    }
                    ...
                    if ($result->rowCount() > 0) {
                        // Define the path to the folder where new arrival product images are stored
                        $newArrivalImageFolder = "../new_arrival/";

                        // Iterate through the new arrival product rows and display them in the table
                        while ($product = $result->fetch()) {
                            echo "<tr>";
                            echo "<td>{$product['product_id']}</td>";
                            echo "<td><img src='{$newArrivalImageFolder}{$product['product_img']}' alt='Product Image' class='product-img'></td>";
                        ...
                        echo "<tr><td colspan='9'>No new arrival products found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        <div class="pagination-container">
            <ul class="pagination">
                <?php
                // Calculate total number of new arrival products
                $total_products_sql = "SELECT COUNT(*) AS total FROM new_arrivals";
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-button').click(function() {
                ...
                $.ajax({
                    url: 'new_arrival_get_product.php',
                    type: 'POST',
            ...
            function confirmProductDelete(productId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'new_arrival_delete_product.php',
