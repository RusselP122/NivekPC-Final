...
<body>
    ...
    <div class="container">
        <h1>NivekPC PRIVACY POLICY </h1>
        
        <p><strong>1. Changes to our privacy policy</strong></p>
        <p>Any changes we may make to our privacy policy in the future will be posted on this page and, where legally necessary, notified to you by e-mail. Please check back frequently to see any updates or changes to our privacy policy. Changes in the privacy policy will be effective when posted on this page, and all persons affected by such changes will be bound by the changes, as of the posting date, unless an objection is made in writing at the address referenced in Section 13 herein, within 14 days after the date of posting.</p>
        ...
        <table>
            ...
            <td>(a) Performance of a contract with you<br>(b) Necessary for our legitimate interests (to recover debts due to us)<br>(c) Facilitating or offering financing options</td>
            </tr>
            <tr>
            ...
            <td>(a) Necessary for our legitimate interests (for running our business, provision of administration and IT services, network security, to prevent fraud and in the context of a business reorganization or group restructuring exercise)<br>(b) Necessary to comply with a legal obligation</td>
            </tr>
            <tr>
        ...
        <p>We keep basic information about our customers (including Contact, Identity, Financial and Transaction Data) for six years after they cease being customers for tax reasons, insurance compliance, and other purposes. We also keep personal information and data about our customers so long as any hardware warranties are in effect.</p>
        <p>In some circumstances you can ask us to delete your data: see Right to be forgotten below for further information.</p>
